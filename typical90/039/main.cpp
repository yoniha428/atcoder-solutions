...
signed main()
{
  ...
  r.build();
  int ans = 0;
  for(auto& [cnt, dis] : r.ans) ans += dis;
  cout << ans / 2 << '\n';
}
/*
木dpはどのようにできそうか
今何個頂点があるかと、それらに対する距離の和があればよさそう？
{0, -1}から始めると頂点1個、距離0になりそう
*/